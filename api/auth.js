// API : /api/auth
// POST → connexion créateur/admin + auth client (register, login, profil)
...
// Générer un token de session simple (admin/créateur)
function generateToken() {
  return crypto.randomBytes(32).toString("hex");
}

// Générer un token client : base64(customerId:random)
